...
const BannerHome = () => {
	...
	return (
		...
		>
			<div className="grid gap-4 lg:gap-8 lg:w-5/12 -mt-12 lg:mt-0">
			...
			<div className="pointer-events-none transition-all hidden place-items-center lg:grid lg:justify-self-end object-cover overflow-hidden w-[400px] h-[400px] xl:w-[600px] xl:h-[600px] 3xl:w-[700px] 3xl:h-[700px]">
				<Lottie
					options={{
						loop: true,
						autoplay: true,
